...
def main():
    ...
    res = sklearn.model_selection.train_test_split(all_files, test_size=0.3, shuffle=True)
    print("Training files: " + str(res[0]))
    print("Test files: " + str(res[1]))
